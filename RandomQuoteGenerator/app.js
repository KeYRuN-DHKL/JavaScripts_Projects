const quotes = [
  ...
  {
    text: "Technology trust is a good thing, but control is a better one.",
  ...
  {
    text: "The price of liberty is eternal vigilance.",
  ...
  {
    text: "A nation that is afraid to let its people judge truth and falsehood is a nation that is afraid of its people.",
    author: "John F. Kennedy",
    category: "politics",
  },
  {
  ...
  {
    text: "Politics is war without bloodshed while war is politics with bloodshed.",
    author: "Mao Zedong",
    category: "politics",
  },
  {
  ...
  {
    text: "Nobody made a greater mistake than he who did nothing because he could only do a little.",
    author: "Edmund Burke",
    category: "politics",
  },
  {
    text: "Public opinion is the thermometer a monarch should constantly consult.",
  ...
  {
    text: "A right delayed is a right denied.",
    author: "Martin Luther King Jr.",
    category: "politics",
  },
  {
  ...
  {
    text: "Politics, as a practice, whatever its professions, has always been the systematic organization of hatreds.",
    author: "Henry Adams",
    category: "politics",
  },
  {
  ...
  {
    text: "Strong people stand up for themselves, but stronger people stand up for others.",
  ...
  {
    text: "Build a name for yourself by helping other people build theirs.",
    author: "Anonymous",
    category: "business",
  },
  {
  ...
  {
    text: "The best love is the kind that awakens the soul.",
  ...
  {
    text: "The real lover is the man who can thrill you by kissing your forehead.",
...
const quoteGeneratorBtn = document.querySelector("#generator");
const quoteCopyBtn = document.querySelector("#copy");
...
const getRandomQuote = () => {
  const quote = getCategorizedQuote();
...
quoteCopyBtn.addEventListener("click", async () => {
  if (quoteText.textContent.trim() === PLACEHOLDER_TEXT) {
    quoteCopyBtn.textContent = "Nothing to copy";
    quoteCopyBtn.classList.remove("border-blue-600", "text-blue-600");
    quoteCopyBtn.classList.add("border-gray-400", "text-gray-400");

    setTimeout(() => {
      quoteCopyBtn.textContent = "Copy";
      quoteCopyBtn.classList.remove("border-gray-400", "text-gray-400");
      quoteCopyBtn.classList.add("border-blue-600", "text-blue-600");
    }, 2000);
  ...
  try {
    ...
    quoteCopyBtn.classList.remove("border-blue-600", "text-blue-600");
    quoteCopyBtn.classList.add("border-green-600", "text-green-600");

    setTimeout(() => {
      quoteCopyBtn.textContent = "Copy";
      quoteCopyBtn.classList.remove("border-green-600", "text-green-600");
      quoteCopyBtn.classList.add("border-blue-600", "text-blue-600");
    }, 2000);
  } catch (error) {
    quoteCopyBtn.textContent = "Failed to copy";
    quoteCopyBtn.classList.remove("border-blue-600", "text-blue-600");
    quoteCopyBtn.classList.add("border-red-600", "text-red-600");

    setTimeout(() => {
      quoteCopyBtn.textContent = "Copy";
      quoteCopyBtn.classList.remove("border-red-600", "text-red-600");
      quoteCopyBtn.classList.add("border-blue-600", "text-blue-600");
    }, 2000);
  }
});
